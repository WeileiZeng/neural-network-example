...
for epoch in range(num_epochs):
    ...
    #loss = nn.CrossEntropyLoss()(y_pred,func(t_train))
    #loss = nn.MSELoss()(y_pred-func(t_train), torch.zeros_like(y_pred))
    loss = nn.MSELoss()(func(t_train), y_pred)
    #print(y_pred)
    #print(torch.cat( (y_pred,func(t_train)),1)[:10])
    #loss = nn.MSELoss()(y_pred,t_train**2+t_train)
    #CrossEntropyLoss
